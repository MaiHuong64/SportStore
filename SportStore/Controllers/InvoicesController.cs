...
namespace SportStore.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Invoices.Include(i => i.Customer).Include(i => i.Employee);
        ...
        public async Task<IActionResult> Create([Bind("InvoiceId,InvoiceCode,InvoiceDate,InvoiceType,CustomerId,EmployeeId")] Invoice invoice)
        {
